...
void LevelA::initialise()
{
   ...
   */
   ...
   mGameState.mc = new Entity(
      {mOrigin.x - 900.0f, mOrigin.y - 175.0f}, // position
      {150.0f, 150.0f},             // scale
      "assets/sword_walk1.png",
      "assets/sword_attack1.png",
   ...
   */
   mGameState.goal = new Entity(
      {mOrigin.x + 925.0f, mOrigin.y + 340.0f}, // position
      {40.0f, 40.0f},             // scale
   ...
   */
   ...
   mGameState.enemy = new Entity(
      {mOrigin.x, mOrigin.y - 25.0f}, // position
      {80.0f, 80.0f},             // scale
